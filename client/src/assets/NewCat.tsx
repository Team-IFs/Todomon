 ...
 * st3: face
 */
const NewCat = ({ todomonColor }: { todomonColor: TodomonColor }) => {
    const backgroundColor = todomonColor.backgroundColor;
    const rightEyeColor = todomonColor.rightEyeColor;
    const leftEyeColor = todomonColor.leftEyeColor;
  const faceColor = todomonColor.faceColor;
  // console.log('current Todomon color: ' + backgroundColor + ' ' + rightEyeColor + ' ' + leftEyeColor + ' ' + faceColor);
  return <>
  <svg version="1.1" id="Layer_1" xmlSpace="preserve"
          ...
          <style type="text/css">{`
            ...
            .st1{fill:${rightEyeColor};}
            .st2{fill:${leftEyeColor};}
            .st3{fill:${faceColor};}
            `}
          </style>
